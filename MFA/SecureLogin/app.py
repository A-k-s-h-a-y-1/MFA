...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'akshay_super_secret_123'
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///database.db'
app.config['MAIL_SERVER'] = 'smtp.gmail.com'
app.config['MAIL_PORT'] = 587
app.config['MAIL_USE_TLS'] = True
app.config['MAIL_USERNAME'] = 'akshaysaran00@gmail.com'
app.config['MAIL_PASSWORD'] = 'lqmh igmc ekdv lohd'
...
def mfa():
    ...
    if request.method == 'POST':
        ...
        totp = pyotp.TOTP(user.otp_secret, interval=120)  # 120 seconds per code
    ...
    otp_code = totp.now()
    msg = Message("Your MFA Code", sender="akshaysaran00@gmail.com", recipients=[user.email])
